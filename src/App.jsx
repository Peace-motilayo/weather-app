...
const Weather = () => {
  ...
  const conditionMap = {
	...
	{/*const Back = () => {
          backRef.current[0].style.display = "none"; 
	  backRef.current[1].style.display = "none";
	  backRef.current[2].style.display = "none";
	  backRef.current[3].style.display = "block";
	  backRef.current[4].style.display = "block";
	  backRef.current[5].style.display = "block";
  }
  */}
  ...
  const Details = () => {
    if (detailsRef.current[0] && detailsRef.current[1]) {
      ...
      detailsRef.current[1].style.display = "none";
      detailsRef.current[2].style.display = "none";
    }
  ...
  return (
    <div className="weather">
      ...
      {pageLoading ? (
        ...
        <>
	      <p className="material-symbols-outlined" style={{ display: "none" }}>
	      arrow_back
	      </p>
          {/* HEADER */}
